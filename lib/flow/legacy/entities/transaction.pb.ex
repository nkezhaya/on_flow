...
defmodule Entities.Transaction do
  ...
  @type t :: %__MODULE__{
          ...
          proposal_key: Entities.Transaction.ProposalKey.t() | nil,
          payer: binary,
          authorizers: [binary],
          payload_signatures: [Entities.Transaction.Signature.t()],
          envelope_signatures: [Entities.Transaction.Signature.t()]
        }
  ...
  field :proposal_key, 5, type: Entities.Transaction.ProposalKey
  field :payer, 6, type: :bytes
  field :authorizers, 7, repeated: true, type: :bytes
  field :payload_signatures, 8, repeated: true, type: Entities.Transaction.Signature
  field :envelope_signatures, 9, repeated: true, type: Entities.Transaction.Signature
end
